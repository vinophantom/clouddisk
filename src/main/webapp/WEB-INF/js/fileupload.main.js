...
$(function () {
    ...
    $("#fileupload").fileupload({
        url: _path + "/users/" + sessionStorage.getItem("user_username") + "/disk/files",
        //dataType: "json",
        ...
        always: function (e, data) {
            console.log(data);
            if (Object.prototype.toString.call(data.result) == "[object String]" && data.result != '') {
            ...
            var status = data.result.status_code;
            //console.log(status);
            switch (status) {
                case 111:
...
function addFile(e, data, marker) {
    ...
    console.log("user_usedSize============" + Number(sessionStorage.getItem("user_usedSize")));
    ...
    browserMD5File(data.files[0], function (err, fileMd5) {
        ...
        data.context.find(".upload-cancel").click(function () {
            ...
            $.ajax({
                type: "DELETE",
                url: _path + "/users/" + sessionStorage.getItem("user_username") + "/disk/files?cancel=" + data.formData.fileMd5,
        ...
        data.context.find(".upload-pause").click(function () {
            ...
            if (icon.hasClass("glyphicon-pause")) {
                ...
                $.ajax({
                    type: "GET",
                    url: _path + "/users/" + sessionStorage.getItem("user_username") + "/disk/files?resume=" + data.formData.fileMd5,
