...
function createFolderNode(folderId, show) {
    ...
    $.ajax({
        ...
        dataType: "json",
        url: _path + "/users/" + sessionStorage.getItem("user_username") + "/disk/folders/" + folderId + "?sort=" + sortType,
        /*
        ...
        success: function (result) {
            console.log(result);
            console.log("folderId===========" + this.folderId + "    result=====" +　result);
    ...
    function confirm() {
        ...
        if (folderName.length == 0) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: _path + "/users/" + sessionStorage.getItem("user_username") + "/disk/folders",
...
function getRecycleItems() {
    $.ajax({
        type: "GET",
        dataType: "json",
        url: _path + "/users/" + sessionStorage.getItem("user_username") + "/disk/folders/3?sort=1",
        contentType: "application/json; charset=utf-8",
        success: function (result) {
...
function getFile(type) {
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: _path + "/users/" + sessionStorage.getItem("user_username") + "/" + type,
        contentType: "application/json; charset=utf-8",
        success: function (result) {
            var files = result.files;
            var node = $('<ul></ul>');
